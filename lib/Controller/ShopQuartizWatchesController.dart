...
class ShopQuartizWatchesController extends GetxController {
  // get the favorite the quartiz watches data
  List data = [];
  getdata() async {
  ...
  addtofavoritee(
    ...
    //so get the product that i want to fav from favoritePage by it name
