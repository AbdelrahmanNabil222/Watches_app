...
class ShopQuartizWatches extends StatelessWidget {
  ShopQuartizWatches({super.key});

//  final ShopQuartizWatchesController controller = Get.find();
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return GetBuilder<ShopQuartizWatchesController>(
              builder: (controller) {
