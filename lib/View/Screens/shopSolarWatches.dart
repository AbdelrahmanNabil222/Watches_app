...
class ShopSolarWatches extends StatelessWidget {
  ShopSolarWatches({super.key});

  // final ShopSolarWatchesController controller = Get.find();
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return GetBuilder<ShopSolarWatchesController>(builder: (controller) {
