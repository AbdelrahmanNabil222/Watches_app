...
class ShopAutomaticWatches extends StatelessWidget {
  ShopAutomaticWatches({super.key});

  //final ShopAutomaticWatchesController controller = Get.find();
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return GetBuilder<ShopAutomaticWatchesController>(
              builder: (controller) {
